...
urlpatterns = [
    ...
    path('userprofile/', accounts_views.userprofile, name='my_account'),
    ...
    path('boards/<pk>/topics/<topic_pk>/reply/', views.reply_post, name='reply_post'),
    path('boards/<pk>/topics/<topic_pk>/posts/<post_pk>/edit/', views.edit_post, name='edit_post'),
]
